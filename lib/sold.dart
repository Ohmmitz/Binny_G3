...
class _SoldpageState extends State<Soldpage> {
  ...
  Widget build(BuildContext context) {
    List<Shop> shop = [
      Shop("Bk Recycle Group", "10B", "0.5km", "assets/images/unnamed.jpg"),
      Shop("ร้านล้อซัยเส็ง(รับซื้อขยะรีไซเคิ้ล)", "30B", "1.0km", "assets/images/shop2.jpg"),
      Shop("ร้านรับซื้อของเก่า สาธุประดิษฐ์ (ตั้งเจริญ)", "35B", "1.4km", "assets/images/shop3.jpg")
    ];
    return Scaffold(
      appBar: AppBar(
        title: Row(
...
class OrderProcessingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<Map<String, dynamic>> orders = [
      {
        'id': 1,
        'product': 'BK Recycle Group',
        'price': 350,
        'status': 'กำลังดำเนินการ',
        'image': 'assets/images/unnamed.jpg', // เพิ่ม key 'image' เพื่อระบุที่อยู่ของรูปภาพ
      },
    ];
      ...
      itemBuilder: (context, index) {
        return ListTile(
          ...
          subtitle: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Product: ${orders[index]['product']}'),
              Text('Price: ${orders[index]['price']} บาท'),
...
class OrderCompletedPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<Map<String, dynamic>> orders = [
      {
        'id': 2,
        'product': 'ร้านล้อซัยเส็ง(รับซื้อขยะรีไซเคิ้ล)',
        'price': 850,
        'status': 'เสร็จสิ้น',
        'image': 'assets/images/shop2.jpg', // เพิ่ม key 'image' เพื่อระบุที่อยู่ของรูปภาพ
      },
    ];
  ...
  Widget build(BuildContext context) {
    List<Map<String, dynamic>> orders = [
      {'id': 3,
        ...
        'price': 1200,
        'status': 'ยกเลิก',
        'image': 'assets/images/shop3.jpg' // เพิ่ม key 'image' เพื่อระบุที่อยู่ของรูปภาพ
      },
    ];
